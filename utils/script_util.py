...
from utils.respace import SpacedDiffusion, space_timesteps
from utils.unet import SuperResModel, UNetModel, EncoderUNetModel
...
def create_model(
    ...
    print('************ input_res = image_size//patch_size **************')
